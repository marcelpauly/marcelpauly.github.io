...
<p>“Showcase your work online: Build a portfolio with GitHub Pages”</p>
...
------ 
## A <i>few</i> words about the important folders and files: 
...
- **index.html**: this is the structure of your website  
  ...
  3. insert your own project links  
...
## A small note about images

The images included here are placeholders.
You can:
- delete them  
- replace them with your own  
- or leave them as temporary visuals during the workshop  
Just make sure that if you change an image, the filename matches what is written in `index.html`.
...
After a few minutes, <i>GitHub will automatically publish your site.</i>

Your portfolio will then be live at:
